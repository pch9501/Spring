...
public class MainClass {
 ...
 public static void main(String[] args) throws Exception{
     String clientId = "6eE3lfhxw2wIbgdLPaRb"; //애플리케이션 클라이언트 아이디값"
     String clientSecret = "VXUhfcqvO_"; //애플리케이션 클라이언트 시크릿값"

     String text = null;
     try {
         text = URLEncoder.encode("마이 스파이", "UTF-8");
     } catch (UnsupportedEncodingException e) {
         throw new RuntimeException("검색어 인코딩실패",e);
     }

     //String apiURL = "https://openapi.naver.com/v1/search/blog?query=" + text;    // json결과
     String apiURL = "https://openapi.naver.com/v1/search/blog.xml?display=100&start=1&query="+ text; // xml결과
