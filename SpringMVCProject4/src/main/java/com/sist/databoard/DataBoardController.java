...
public class DataBoardController {
	...
	public String board_detail(Model model,int no)
	{
		...
		if(vo.getFilecount()>0)
		{
			...
			// fList, sList를 하나의 List로 묶어야, fList[0]과 sList[0] 이런식으로 index 번호가 같은 fList,sList를 for문으로 한 번에 출력할 수 있다.
		}
	...
	public String databoard_delete(Model model,int no) // no 보내줘야해서 model 필요함 
	{
